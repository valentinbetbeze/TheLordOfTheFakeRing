 ...
 */
static void get_frame_indexes(const int16_t x, const int16_t y, uint16_t *row, uint16_t *column)
{
    if (row == NULL) {
 ...
 */
static void write_to_frame(const int16_t x, const int16_t y, const uint16_t color, const float alpha)
{
 ...
 */
static void rasterize_circle(const circle_t *circle, const uint8_t x, const uint8_t y)
{
    if (circle == NULL) {
