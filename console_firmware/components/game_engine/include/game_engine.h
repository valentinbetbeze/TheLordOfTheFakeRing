 ...
 * left side.
 */
uint8_t check_block_collisions(const map_t *map, physics_t *physics, music_t **music,
 ...
 */
void spawn_enemies(const map_t *map, const uint16_t cam_pos_x, const int16_t start_row,
                   const int16_t end_row);
